...
public class CambioPasswordRestSteps {
    ...
    public void vieneSottomessaLaNuovaPasswordMaNonCambiataACausaDelFormato() {
        Response responseCambioPassword = CambioPassword.path("KTMFSW67T64I460A").request().header(HttpHeaders.AUTHORIZATION, "Basic "+token).put(Entity.text(passwordErrata));
