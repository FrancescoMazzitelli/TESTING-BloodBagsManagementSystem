...
public class ReportGiacenzaMediaSaccheLocaleRestTest {
    ...
    /**Popola il database di Sacche utili per le query e aggiunge e logga con un AmministratoreCTT
	...
	for(DatiSacca datisac : listaDatiSacche) {
     ...
     String username = "Amministratore1";
     String password = "Amministratore1";
