...
public class AggiungiDipendenteTest {
	...
	@Before public void setUp() throws EntityAlreadyExistsException {
			...
			cdf = Cdf.getCDF("SRNGJZ50B54C143L");
			ld = LocalDate.parse("1988-07-04", DateTimeFormatter.ofPattern(Constants.DATEFORMAT));
			ruolo = RuoloDipendente.MagazziniereCTT;
			username = "username 123";
			password = "Password123";
			Dipendente dip123 = new Dipendente(cdf, "Ario", "lucarelli", ld, ruolo, username, password);
			listaDipendenti.add(dip123);

			cdf = Cdf.getCDF("LZZBHR41C46C446V");
			ld = LocalDate.parse("1977-04-01", DateTimeFormatter.ofPattern(Constants.DATEFORMAT));
			ruolo = RuoloDipendente.OperatoreCTT;
			username = "username 234";
			password = "Password234";
			Dipendente dip234 = new Dipendente(cdf, "Lucio", "Spora", ld, ruolo, username, password);
			listaDipendenti.add(dip234);
