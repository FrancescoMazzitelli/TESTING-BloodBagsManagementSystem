...
public class ReportGiacenzaMediaSaccheRegionaleRestTest {
     ...
     */
    @Before
    public void setUp() throws EntityAlreadyExistsException { List<Dipendente> listaDipendenti = new ArrayList<Dipendente>();
    ...
    /** Test per il metodo rest/CCS/giacenzaMediaSaccheCCS dell'amministratoreCCS, va a buon fine*/
    @Test
